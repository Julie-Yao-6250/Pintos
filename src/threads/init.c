...
static void run_kernel_monitor(void);
static void read_monitor_line(char *buf, size_t size);
...
static void
read_monitor_line(char *buf, size_t size)
{
  size_t i = 0;
...
run_kernel_monitor(void)
{
  ...
  {
    printf("ICS143A> ");
    read_monitor_line(cmd, sizeof cmd);
